...
export function Manifesto() {
  const t = () => (key)=> key // dummy translator("landing.sections");
  return (
...
export function Features() {
  const tLanding = (() => (key)=> key)("landing");
...
export function Model() {
  const t = () => (key)=> key // dummy translator("landing.sections");
  const steps = (() => (key)=> key)("landing").raw("steps") as { n: string; title: string; desc: string }[];
...
export function FoundingSection() {
  const t = () => (key)=> key // dummy translator("founding");
  const tNav = (() => (key)=> key)("nav");
  return (
    <Container className="py-14 sm:py-18">
...
export function ContactSection() {
  const t = () => (key)=> key // dummy translator("partners");
  return (
    <Container className="py-14 sm:py-18">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-8 sm:p-10">
        <h3 className="text-2xl font-semibold tracking-tight">{t("title")}</h3>
